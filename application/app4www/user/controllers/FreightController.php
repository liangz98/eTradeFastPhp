...
class FreightController extends Kyapi_Controller_Action {
    ...
    public function indexAction() {
        ...
        if (defined('SEED_WWW_TPL')) {
            $content = $this->view->render(SEED_WWW_TPL . "/freight/index.phtml");
            echo $content;
            exit;
        }
    }
    ...
    // 详情页
    public function freightViewAction() {
        $this->view->resultMsg = $this->_request->getParam('resultMsg');

        if (defined('SEED_WWW_TPL')) {
            $content = $this->view->render(SEED_WWW_TPL . "/freight/freightView.phtml");
            echo $content;
            exit;
        }
    }
    ...
    public function freightLoanIndexAction() {
        ...
        if (defined('SEED_WWW_TPL')) {
            $content = $this->view->render(SEED_WWW_TPL . "/freight/freightLoanIndex.phtml");
            echo $content;
            exit;
        }
    }
    ...
    // 金融项目详情
    public function freightLoanViewAction() {
        $this->view->resultMsg = $this->_request->getParam('resultMsg');

        if (defined('SEED_WWW_TPL')) {
            $content = $this->view->render(SEED_WWW_TPL . "/freight/freightLoanView.phtml");
            echo $content;
            exit;
        }
    }
    ...
    // 金融项目还款
    public function freightLoanPaymentAction() {
        $this->view->resultMsg = $this->_request->getParam('resultMsg');

        if (defined('SEED_WWW_TPL')) {
            $content = $this->view->render(SEED_WWW_TPL . "/freight/freightLoanPayment.phtml");
            echo $content;
            exit;
        }
    }
