...
//        Seed_Cookie::setCookie('seed_VmallLastUrl',$wc_cur_url,$expiretime, $this->view->seed_Setting['cookie_path'], $this->view->seed_Setting['cookie_host']);
        ...
        $this->view->cates = $newsCateM->fetchRows(null,array('parent'=>0),"order_by asc");
        ...
        if(defined('SEED_V_TPL')){
            $content = $this->view->render(SEED_V_TPL."/news/index.phtml");
            echo $content;
            exit;
        }
    }
    ...
    function getnewsAction(){
        ...
        if(defined('SEED_V_TPL')){
            $content = $this->view->render(SEED_V_TPL."/news/newslist.phtml");
            echo $content;
            exit;
        }
    }
...
//        Seed_Cookie::setCookie('seed_VmallLastUrl',$wc_cur_url,$expiretime, $this->view->seed_Setting['cookie_path'], $this->view->seed_Setting['cookie_host']);
        ...
        if(defined('SEED_V_TPL')){
            $content = $this->view->render(SEED_V_TPL."/news/detail.phtml");
            echo $content;
            exit;
        }
    }
