...
class Zend_View_Helper_ShowSimpleOrderContract extends Shop_View_Helper {
     ...
     */
    function ShowSimpleOrderContract($contract, $accountID, $loanStatus) {
        $result = '';
        ...
        if ($loanStatus == '00' || $loanStatus == '04' || $loanStatus == '05')
            ...
            if (count($contract['attachmentList']) > 0) {
                ...
                $result .= '<a href="javascript:void(0)" id="' . $contract['contractID'] . '" onclick="initPdfView(\'' . $pdfUrl . '\', this)" class="btn btn-warning order_contract_sign fr">查看</a>';
            }
        }
