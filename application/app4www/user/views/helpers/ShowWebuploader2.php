<?php
class Zend_View_Helper_ShowWebuploader2 extends Shop_View_Helper
{
	function ShowWebuploader2($attArr,$bizType,$attachType,$type,$goodsID)
	{
        //$attArr 服务端返回附件信息数组；
        ...
        $showimg.='</ul><ul class="upload-image-list clearfix"><input id="CROD" type="hidden" value="ODSE"><div class="fileinput-button js-add-image" onclick="addWebuploadCurrent($(this))">'.$indata;
