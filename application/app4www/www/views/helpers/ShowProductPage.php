...
class Zend_View_Helper_ShowProductPage
{
	function ShowProductPage($page)
	{
		...
		if (is_array($page) && $page['totalpage']>1){
			...
			$str.= '<span class="page_l"><a href="'.$page['pageurl']."-".$page['prepage'].'.html"><img src="/images/ui/page_l.gif"></a></span>';
			...
			$str.= '<span class="page_r"><a href="'.$page['pageurl']."-".$page['nextpage'].'.html"><img src="/images/ui/page_r.gif"></a></span>';
