<?php
class TestfileController extends Shop_Controller_Action 
{
	function indexAction()
	{
		...
		if(count($files)==0){
			Seed_Browser::redirect("没有文件选择",$this->view->seed_BaseUrl."/testfile/upload?&name=".$name."&token=".$this->view->seed_Token);
		}
		$this->view->name=$name;
