...
function FCKeditor_IsCompatibleBrowser()
{
    ...
    else if ( preg_match( "|AppsinaEditorleWebKit/(\d+)|i", $sAgent, $matches ) )
    {
        $iVersion = $matches[1] ;
...
class FCKeditor
{
    ...
    public function CreateHtml()
    {
        ...
        if ( $this->IsCompatible() )
        {
            ...
            $Html .= "<iframe id=\"{$this->InstanceName}___Frame\" src=\"{$Link}\" width=\"{$this->Width}\" height=\"{$this->Height}\" frameborder=\"0\" scrolling=\"no\" name=\"{$this->InstanceName}___Frame\"></iframe>" ;
        }
        else
        {
    ...
    {
        return true;//FCKeditor_IsCompatibleBrowser() ;
    }
