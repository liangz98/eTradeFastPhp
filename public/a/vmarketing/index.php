...
//应用根目录
define('SEED_APP_ROOT',realpath('../../../application/app4center/vmarketing'));
//配置根目录
...
//默认控制器
define('SEED_CONTROLLER_DIRECTORY',realpath('../../../application/app4center/vmarketing/controllers'));
//配置FCK目录
