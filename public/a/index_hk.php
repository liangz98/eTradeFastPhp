...
/**定义常量*/
//当前系统模块名称
define('CURRENT_MODULE_NAME','center_hk');
...
//应用根目录
define('SEED_APP_ROOT',realpath('../../application/app4center/default'));
//配置根目录
...
//默认控制器
define('SEED_CONTROLLER_DIRECTORY',realpath('../../application/app4center/default/controllers'));
//配置FCK目录
