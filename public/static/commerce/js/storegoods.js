$(function($){
    ...
    $("#goods-search").select2({
        ...
        formatSelection: function(row) {     
            ...
            var html = '';
            var tdHtml = '<td><input type="text" name="sub_goods_number[]" value="0" class="stockNum" style="width:50px;"/></td>'+
                '<td><input type="text" name="goods_number[]" value="0" class="stockNum" style="width:35px;"/></td>'+
                '<td>' + shop_price + '</td>'+
                '<td>' + stock_barcode + '</td>'+
