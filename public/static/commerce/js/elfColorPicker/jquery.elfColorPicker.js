...
(function ($) {
    ...
    $.fn.elfColorPicker = function (options) {
        var opts = $.extend({}, $.fn.elfColorPicker.defaults, options);
        return this.each(function () {
            var id = new Date().getTime();
            var trigger = $(this);
            var o = $.metadata ? $.extend({}, opts, trigger.metadata()) : opts;
            ...
            function eventHandle(trigger, elfColorPickerObj, valueFor, extraColorLump) {
                ...
                trigger.click(function () {
                     ...
                     */
                    if (o.triggerType == "button" && trigger.attr("disabled")) {
                        return;
                    }
    ...
    //扩展jQuery的静态方法
    $.elfColorPicker = function (options) {
        $(":text.dateInputer").elfColorPicker(options);
    };
})(jQuery);