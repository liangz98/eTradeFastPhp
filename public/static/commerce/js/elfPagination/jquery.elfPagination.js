...
(function ($) {
    ...
    $.extend(ElfPagination.prototype, {
        ...
        _renderPages: function () {
            ...
            for (var page = 1; page <= this._o.totalPage; page++) {
                ...
                if (isEdge || isSibling || isCurr) {
                    this._container.append('<a href="javascript:void(0)" class="page_jd ' + first + ' ' + last + ' ' + (isCurr ? "curr" : "") + '" page="' + page + '">' + page + '</a>');
        ...
        _bindEvent: function () {
            ...
            container
                .delegate(".page_jd", "click",function () { // 点击页码
        ...
        return this.each(function () {
            ...
            if (typeof options === "string") { // 第一个参数是String类型的. 则进行调用方法
                ...
                if (!instance) { // 之前没有初始化过,则初始化
                    ...
                    instance["_applyOptions"].call(instance, options);
                }
            }
        });
    };
