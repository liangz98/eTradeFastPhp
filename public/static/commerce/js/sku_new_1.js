(function ( $, _, window, document, undefined ) {
    ...
    function Stock(skuList) {
        ...
        this.thead = '<thead>\n<tr>\n<%=theadHtml %><th class="th-price">商品原价（元）</th>\n<th class="th-price">商品抢购价（元）</th>\n<th class="th-price">供货价格（元）</th>\n<th class="th-price">最低价格（元）</th>\n<th class="th-price">推荐佣金（元）</th>\n<th class="th-stock">库存</th>\n</tr>\n</thead>\n';
        ...
        '<input type="text" name="stock_array[<%=group_index %>][stocks][<%=stock_index %>][stock_union_price]" tag="union_price" class="js-price input-mini" value="<%=union_price %>" />\n</td>\n<td>\n<input type="text" name="stock_array[<%=group_index %>][stocks][<%=stock_index %>][stock_min_price]" tag="min_price" class="js-price input-mini" value="<%=min_price %>" />\n</td>\n<td>\n' +
        '<input type="text" name="stock_array[<%=group_index %>][stocks][<%=stock_index %>][stock_recommend_price]" tag="recommend_price" class="js-price input-mini" value="<%=recommend_price %>" />\n</td>\n<td>\n<input type="text" name="stock_array[<%=group_index %>][stocks][<%=stock_index %>][stock_value]" tag="stock_value" class="js-stock-num input-mini" value="<%=stock_value %>" />' +
