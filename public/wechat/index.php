...
//应用根目录
define('SEED_APP_ROOT',realpath('../../application/app4www/wechat'));
//配置根目录
...
//文件目录
define('SEED_FILE_ROOT',realpath('../upload_files/files'));
//默认控制器
define('SEED_CONTROLLER_DIRECTORY',realpath('../../application/app4www/wechat/controllers'));
//授权目录
...
/** session */
Zend_Session::start();
$session = new Zend_Session_Namespace('V_Gzseed_Session');
