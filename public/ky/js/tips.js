...
document.writeln(".tips_bg .pop_tips1,.tips_bg .pop_tips2{width:auto;background:rgba(50,50,50,0.9);padding:15px;color:#999;display:inline-block;border-radius:8px;margin-top:20%;}");
...
document.writeln(".tips_bg .pop_tips2 p{padding:15px 0;font:16px/40px \"Microsoft YaHei\";}");
document.writeln(".tips_bg .pop_tips2 p a{height:40px;padding:0 20px;background:#3c3c3c;color:#999; display:inline-block;border-radius:8px; box-shadow:0 1px 2px #666 inset;margin:0 8px;border:1px solid #181818;white-space:nowrap;}");
