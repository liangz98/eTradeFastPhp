 ...
 function webupload_pic() {
    ...
    $.getScript("../../ky/upload/Public/js/plugins/webuploader/webuploader.js", function() {
        ...
        uploader.on('fileQueued', function(file) {
            ...
            $(".webupload_current1").parent().parent().find('.img-view').prepend(item_progress);
        ...
        uploader.on('uploadSuccess', function(file, response) {
          ...
          //  str={"nid":nid,"name":name,"size":size,"attachType":attachType};
            ...
            if (type!="jpeg" && type!="png" && type!="jpg" && type!="gif" && type!="GIF" && type!="JPG" && type!="PNG"){
                ...
                $(".webupload_current1").parent().parent().find('.img-view').prepend("<li><a href=" + response.doc + " download><img width='125px' height='125px' class='img_common' src='/ky/ico/"+type+".png' alt="+name+"></a><span class='del_to' >"+name+"</span>" +
                ...
                if(attachTT=="CRSE"){
                     if($(".webupload_current1").parent().parent().parent().find('#KEY_CRCT').length>0){
                        var k=$(".webupload_current1").parent().parent().parent().find('#KEY_CRCT').val();
                        if(k==null&&k==""){k=0;}
                        var g=Number(k)+1;
                        $(".webupload_current1").parent().parent().parent().find('#KEY_CRCT').val(g);
                      }
                ...
                $(".webupload_current1").parent().parent().find('.img-view').prepend("<li><img width='125px' height='125px' class='img_common' src="  + response.pic + " data-pic=" + response.pic + " alt=''/><span class='del_to' ><a onclick='view_pic(this)'>查看</a>|<a onclick='delete_pic(this)'>删除</a></span>" +
                "<input type='hidden' name='attachNid[]' value=" +nid+ "><input type='hidden'  name='attachName[]' value="+name+ "><input type='hidden'  name='attachSize[]' value="+size+ "><input type='hidden'  name='attachType[]' value='CRSE'><input type='hidden'  name='bizType[]' value=''></li>");
                if(attachTT=="CRSE"){
                    if($(".webupload_current1").parent().parent().parent().find('#KEY_CRCT').length>0){
                        var k=$(".webupload_current1").parent().parent().parent().find('#KEY_CRCT').val();
                        if(k==null&&k==""){k=0;}
 ...
 function addWebuploadCurrent(obj) {
    $(".webupload_current1").removeClass("webupload_current");
    obj.addClass("webupload_current1");
