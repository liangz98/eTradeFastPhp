...
/**定义常量*/
//当前系统模块名称
define('CURRENT_MODULE_NAME','upload');
...
//应用根目录
define('SEED_APP_ROOT',realpath('../../application/app4www/uploadapi'));
//配置根目录
define('SEED_CONF_ROOT',realpath('../../config'));
//缓存根目录
define('SEED_CACHE_ROOT',realpath('../../cache'));
//默认控制器
define('SEED_CONTROLLER_DIRECTORY',realpath('../../application/app4www/uploadapi/controllers'));
//授权目录
