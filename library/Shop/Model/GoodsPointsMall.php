 ...
 */
class Shop_Model_GoodsPointsMall extends Seed_Model_Db
{
    /**
     * 无前缀的表名
     *
     * @var string
     */
    public $_table_name = 'goods_pointsmall';
     ...
     *
     */
    function fetchPointsMallList($limit = array(0,0) , $condiction=null , $orcondition=null , $order_by=null , $fetch_fields="*" , $debug=false){
        try {
     ...
     *
     */
    function fetchPointsMallCount($condiction=null , $orcondition=null, $debug=false){
        try {
            $select = $this->_db->select();
     ...
     *
     */
    function fetchGoodsWithoutPoint($limit = array(0, 0), $condiction = null, $order_by = null, $fetch_fields = '*', $debug = false) {
        try {
            $select = $this->_db->select();
     ...
     *
     */
    function fetchGoodsWithoutPointCount($condiction = null, $debug = false){
        try {
            $select = $this->_db->select();
