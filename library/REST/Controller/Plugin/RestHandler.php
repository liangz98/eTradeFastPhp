    ...
    private function handleActions(Zend_Controller_Request_Abstract $request)
    {
        ...
        foreach ($methods as &$method) {
            if ($method->getDeclaringClass()->name != 'REST_Controller') {
                ...
                } elseif (substr($name, -6) == 'ACTION'/* and $name != 'INDEXACTION'//与156行配合用于匹配INDEX [rainame 2015-07-10]*/) {
        ...
        if (!in_array(strtoupper($request->getActionName()), $actions)) {//getMethod 改为 getActionName [rainame 2015-07-10]
