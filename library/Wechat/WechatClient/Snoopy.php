...
class Wechat_WechatClient_Snoopy
{
	/**** Public variables ****/
	...
	var $_fp_timeout	=	30;					// timeout for socket connection
        ...
        var $_get_source_data   =       false;      //获取源数据(自主添加的参数)
	/*======================================================================*\
	 Function:	fetch
...
//			curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, FALSE);
	...
	function setcookies()
	{
        ...
        function set_SourceData($bool = false)
        {
            $this->_get_source_data = (bool)$bool;
        }
