<?php
class Vuser_Controller_Action extends Zend_Controller_Action
{
	public function init()
	{
		...
		$this->view->addHelperPath(SEED_LIB_ROOT . '/Vuser/View/Helper');
	...
	protected function initUser()
	{
        ...
        if(is_array($my) && isset($my['user_id']) && $user_id == $my['user_id']){
              ...
              $this->view->wechat_User = $wechatUserM->fetchRow(array('user_id'=>$my['user_id']));
            if($user){
                //设置cookie
	...
	protected function initSetting()
	{
		...
		$seed_v_tpl = isset($_GET['tpl'])?trim($_GET['tpl']):'';
		if(!empty($seed_v_tpl)){
